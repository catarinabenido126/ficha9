                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="texto_endereco"
                                            name="morada_cliente" value="Rua da Madeira, 126, 2º">
                                    </div>
                                </div>
